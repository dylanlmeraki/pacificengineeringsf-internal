...
import { Bell, X, Check, MessageSquare, FileText, DollarSign, AlertTriangle, CheckCircle } from "lucide-react";
...
export default function NotificationCenter({ user }) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <Card className="absolute right-0 top-12 w-96 shadow-2xl border-0 z-50">
